"""
Returns a character background
"""
...
class Acolyte:
    def __init__(self):
        ...
        self.features = [["Shelter of the Faithful",
                          ...
                          " adventuring companions can expect to receive free healing and care "
                          ...
                          "Those who share your religion will support you (but only you) at a "
                          "modest lifestyle. You might also have ties to a specific temple "
                          "dedicated to your chosen deity or pantheon, and you have a residence "
                          "there. This could be the temple where you used to serve, if "
                          "you remain on good terms with it, or a temple where you have found a"
                          " new home. While near your temple, you can call upon the priests "
                          "for assistance, provided the assistance you ask for is not hazardous "
